...
/* ------------------------------------------------------------------ */
decNumber * decNumberFromInt(decNumber *dn, Int in) {
  uInt unsig;
  if (in>=0) unsig=in;
  ...
  // in is now positive
  decNumberFromUInt(dn, unsig);
  if (in<0) dn->bits=DECNEG;            // sign needed
  return dn;
  } // decNumberFromInt

decNumber * decNumberFromUInt(decNumber *dn, uInt uin) {
...
decNumber * decNumberLogB(decNumber *res, const decNumber *rhs,
  ...
  if (decNumberIsNaN(rhs)) decNaNs(res, rhs, NULL, set, &status);
    ...
    decNumberFromInt(res, ae);          // lay it out
    }
...
decNumber * decLnOp(decNumber *res, const decNumber *rhs,
  ...
  do {                                  // protect allocated storage
    ...
    decNumberFromInt(a, r);             // a=r
    decNumberFromInt(b, 2302585);       // b=ln(10) (2.302585)
    b->exponent=-6;                     //  ..
    ...
    decNumberFromInt(b, t>>2);          // b=ln(b) coefficient
